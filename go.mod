module github.com/sausheong/vdb
...
require (
	github.com/jmorganca/ollama v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/pdevine/tensor v0.0.0-20240228013915-64ccaa8d9ca9 // indirect
